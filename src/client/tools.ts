  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        width: { type: "number", description: "Viewport width for ada's own browser (default 1280). Ignored in the user's real Chrome - their window keeps its size." },
        height: { type: "number", description: "Viewport height for ada's own browser (default 800). Ignored in the user's real Chrome." },
