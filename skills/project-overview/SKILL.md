...
3. Describe the architecture: the main components, how they fit together, and the one or two design decisions that shape it (link an architecture diagram rather than re-prosing it — see the `diagram` skill).
